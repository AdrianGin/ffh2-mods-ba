...
void CvGlobals::cacheGlobals()
{
	...
	//Same as AND TECH PREREQs
	m_iNUM_UNIT_OR_TECH_PREREQS = getDefineINT("NUM_UNIT_AND_TECH_PREREQS");
...
int CvGlobals::getNUM_UNIT_OR_TECH_PREREQS()
{
	return m_iNUM_UNIT_OR_TECH_PREREQS;
}
