...
void CyPlayerPythonInterface1(python::class_<CyPlayer>& x)
{
	...
	x
		...
		.def("calculateFoodCosts", &CyPlayer::calculateFoodCosts, "int ()")
		.def("calculateGoldRate", &CyPlayer::calculateGoldRate, "int ()")
		.def("calculateFoodRate", &CyPlayer::calculateFoodRate, "int ()")
		...
		.def("getFood", &CyPlayer::getFood, "int ()")
		.def("setFood", &CyPlayer::setFood, "void (int iNewValue)")
		.def("changeFood", &CyPlayer::changeFood, "void (int iChange)")
		.def("getFoodPerTurn", &CyPlayer::getFoodPerTurn, "int ()")
